/*
ДЛЯ SMART PLANNER ВСЕГДА ДОЛЖНО БЫТЬ ИНИЦИАЛИЗИРОВАНА ЗАДАЧА
*/
...
18) сделать add_weights отдельно для каждой ориентации агента
19) сделать отжиг по add_weights
20) агентов, которые очень скоро выполнят задачу, тоже можно добавить в free_robots!!!
