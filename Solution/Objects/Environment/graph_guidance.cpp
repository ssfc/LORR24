...
void GraphGuidance::set_sortation() {
    ...
    // 35816 -> 38860
    {
        ...
        add(0, 0, 5, cols - 1, 1, 0, 1);
        add(0, 0, 5, cols - 1, 2, 0, 1);
        add(0, 0, 5, cols - 1, 3, 0, 1);

        add(133, 0, 139, cols - 1, 0, 0, 1);
        add(133, 0, 139, cols - 1, 1, 0, 1);
        add(133, 0, 139, cols - 1, 2, 0, 1);
        add(133, 0, 139, cols - 1, 3, 0, 1);
    }
}
