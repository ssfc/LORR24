...
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/random.domain/RANDOM-01.json -o test.json -s 600 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/random.domain/RANDOM-02.json -o test.json -s 600 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/random.domain/RANDOM-03.json -o test.json -s 800 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
...
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/random.domain/RANDOM-05.json -o test.json -s 2000 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/city.domain/CITY-01.json -o test.json -s 3000 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/city.domain/CITY-02.json -o test.json -s 3000 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/game.domain/GAME.json -o test.json -s 5000 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
// ./bin/lifelong -i ./2024main-instance/MainRoundEvaluationInstances/warehouse.domain/SORTATION.json -o test.json -s 5000 -t 300 -p 1800000 --pa 'epibt(4)' --gg enable --sa greedy
